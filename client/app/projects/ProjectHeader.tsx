  ...
  return (
    <div className=" px-4 xl:px-6">
      ...
      <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
        ...
        buttonComponent={
          <button className="flex items-center rounded-md bg-blue-primary px-3 py-2 text-white hover:bg-blue-600" onClick={()=>{
      ...
      <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center">
        ...
        <div className="flex items-center gap-2">
            ...
            <div className="relative">
                <input type="text" placeholder="Search task" className="rounded-md border py-1 pr-4 pl-10 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white"/>
                <Grid3x3 className="absolute left-3 top-2 w-3 h-3 text-gray-400 dark:text-neutral-500"/>
            </div>
        </div>
      </div>
    </div>
