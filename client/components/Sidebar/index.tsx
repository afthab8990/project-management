...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, BriefcaseBusiness, ChevronDown, ChevronUp, Home, HomeIcon, Icon, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
  ...
  return (
    <div className={sideBarClassNames}>
      <div className='flex h-[100%] flex-col justify-start '>
        ...
        {/* Team */}
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-400 px-8 py-4 dark:border-gray-700 '>
            <Image src={'https://pm-s3-img-bucket.s3.ap-south-1.amazonaws.com/logo.png'} alt='Logo' width={40} height={40}/>
            <div>
      ...
      <div className='flex w-full items-center'>
                ...
                <button className='self-start rounded bg-blue-400 py-2 px-4 text-xs font-bold text-white hover:bg-blue-500 md:block' onClick={handleSignOut}>Sign Out</button>
              </div>
            </div>
    </div>
